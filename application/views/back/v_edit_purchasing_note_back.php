                                            ...
                                            <tbody id="" >	
                                                ...
                                                foreach ($datapurchasingnote as $item) {
                                                    ...
                                                    <tr>
                                                        <td> 
                                                            <div>
                                                                <select onclick="get_idselect()" onchange="check_material()" id="id_editmaterial_<?php echo $urutan; ?>" class="form-control" name="name_editmaterials[]"  id="select-1" selected ="select"  >
                                                                    <?php
