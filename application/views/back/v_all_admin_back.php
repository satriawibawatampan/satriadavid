        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form id="smart-form-register-edit" action="<?php echo base_url(); ?>Back/Admin/Edit_admin" class="smart-form" novalidate="novalidate" method="post">
                    ...
                    <fieldset>
                        <section>
                            ...
                            <label class="input"> <i class="icon-append fa fa-puzzle-piece"></i>
                                <input readonly  id="id_editemail" type="text" name="name_editemail"  aria-required="true" class="error" id="id_editnamecompany" aria-invalid="true" value="<?php echo set_value('name_editemail'); ?>">
                    ...
                    <fieldset>
                        <label class="input control-label">Admin Type</label>
                        <section>
                            <label class="input"> <i class="icon-append fa fa-puzzle-piece"></i>
                               <select id="id_edittype" class="form-control" name="name_edittype" id="select-1" selected ="select" >
                                    <?php
                                    foreach ($listadmintype as $hasil) {
                                        echo "<option value='" . $hasil->id . "'" . set_select('name_edittype', $hasil->id, TRUE) . ">" . $hasil->nama . "</option>";
                                    }
                                    ?>
...
<!--                    <div class="form-group">
                    ...
                    <fieldset>
                        <label class="input control-label">Branch</label>
                        <section>
                            <label class="input"> <i class="icon-append fa fa-puzzle-piece"></i>
                                <select id="id_editbranch" class="form-control" name="name_editbranch" id="select-1" selected ="select" >
                                    <?php
                                    foreach ($listbranch as $hasil) {
                                        echo "<option value='" . $hasil->id . "'" . set_select('name_editbranch', $hasil->id, TRUE) . ">" . $hasil->nama . "</option>";
                                    }
                                    ?>
                            ...
                            <span class="col-md-9 text-danger">
                                <?php echo form_error('name_editbranch'); ?>
                            </span>
                        </section>
                    </fieldset>
                    <footer>
                        <input type="submit" name="button_editadmin" class="btn btn-primary" value="Submit">
                    </footer>
                </form>	
            </div>
        </div>
 ...
 $(document).ready(function () {
        ...
        if (idopen != "")
        {
           // alert("as");
            ...
            function showeditdataadmin(idnya, nama)
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>" + "Back/Admin/Json_get_one_admin/" + idnya,
                    dataType: "json",
