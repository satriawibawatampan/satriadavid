    ...
    <div class="jarviswidget jarviswidget-sortable" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
        ...
        <div role="content">
            ...
            <div class="widget-body ">
                ...
                <form role='form' id="smart-form-register-payment" action="<?php echo base_url(); ?>Back/Member/Exchange_point" class="form-horizontal" novalidate="novalidate" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Poin to exchange</label>
                        <div class="col-md-3">
                            <input class="form-control" id="id_minimaltukar" name="name_minimaltukar" min="<?php echo $datasetting[0]->minimaltukarpoin; ?>" type="number" value="<?php echo set_value('name_deposit', $datasetting[0]->harga_deposit); ?>">
                            <input class="form-control" id="id_pointtodeposit" name="name_pointtodeposit" min="<?php echo $datasetting[0]->nilaipoinkedeposit; ?>" type="number" value="<?php echo set_value('name_deposit', $datasetting[0]->harga_deposit); ?>">
