	...
	<body class="">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="activity" class="activity-dropdown"> <i class="fa fa-user"></i> <b class="badge"> 25 </b> </span>
			...
			<div class="pull-right">
				...
				<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
					<li class="">
						<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
							<img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/avatars/sunny.png" alt="John Doe" class="online" />  
						</a>
				...
				<ul class="header-dropdown-list hidden-xs">
					<li>
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/blank.gif" class="flag flag-us" alt="United States"> <span> English (US) </span> <i class="fa fa-angle-down"></i> </a>
						<ul class="dropdown-menu pull-right">
							<li class="active">
								<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/blank.gif" class="flag flag-us" alt="United States"> English (US)</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/blank.gif" class="flag flag-fr" alt="France"> Français</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/blank.gif" class="flag flag-es" alt="Spanish"> Español</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/blank.gif" class="flag flag-de" alt="German"> Deutsch</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/blank.gif" class="flag flag-jp" alt="Japan"> 日本語</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/blank.gif" class="flag flag-cn" alt="China"> 中文</a>
							</li>	
							<li>
								<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/blank.gif" class="flag flag-it" alt="Italy"> Italiano</a>
							</li>	
							<li>
								<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/blank.gif" class="flag flag-pt" alt="Portugal"> Portugal</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/blank.gif" class="flag flag-ru" alt="Russia"> Русский язык</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/blank.gif" class="flag flag-kr" alt="Korea"> 한국어</a>
							</li>						
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
					...
					<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						<img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/avatars/sunny.png" alt="me" class="online" /> 
						<span>
							john.doe 
						</span>
								...
								<div class="display-users">
									...
									<input class="form-control chat-user-filter" placeholder="Filter" type="text">
								  	...
								  	<a href="#" class="usr" 
									  	...
									  	data-content="
											<div class='usr-card'>
												<img src='<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/avatars/5.png' alt='Sadi Orlaf'>
									...
									<a href="#" class="usr" 
										data-chat-id="cha2" 
									  	...
									  	data-content="
											<div class='usr-card'>
												<img src='<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/avatars/1.png' alt='Jessica Dolof'>
												<div class='usr-card-content'>
													<h3>Jessica Dolof</h3>
									...
									<a href="#" class="usr" 
									  	...
									  	data-content="
											<div class='usr-card'>
												<img src='<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/avatars/3.png' alt='Zekarburg Almandalie'>
												<div class='usr-card-content'>
									...
									<a href="#" class="usr" 
									  	...
									  	data-content="
											<div class='usr-card'>
												<img src='<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/avatars/4.png' alt='Barley Krazurkth'>
												<div class='usr-card-content'>
									...
									<a href="#" class="usr offline" 
									  	...
									  	data-content="
											<div class='usr-card'>
												<img src='<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/avatars/female.png' alt='Farhana Amrin'>
												<div class='usr-card-content'>
													<h3>Farhana Amrin</h3>
									...
									<a href="#" class="usr offline" 
										data-chat-id="cha6" 
									  	...
									  	data-content="
											<div class='usr-card'>
												<img src='<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/avatars/male.png' alt='Lezley Jacob'>
												<div class='usr-card-content'>
													<h3>Lezley Jacob</h3>
													<p>Sales Director</p>
												</div>
									...
									<a href="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/ajax/chat.html" class="btn btn-xs btn-default btn-block sa-chat-learnmore-btn">About the API</a>
