                        ...
                        <div role="content">
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <div class="padding-10">
                                    <br>
                                    <div class="pull-left">
                                        <img src="<?php echo base_url(); ?>HTML_Full_Version_v1.8.2/img/Stempel 2.png" width="150" height="32" alt="invoice icon">

                                        <address>
                                            <br>
                                            <strong>LaiKeBao Convection</strong>
                                            <br>
                                            Jalan Demak 314
                                            <br>
                                            Surabaya - 60171, Indoneisa
                                            <br>
                                            <abbr title="Phone">P:</abbr> (081) 23310 3199
                                        </address>
                                    </div>
                                    ...
                                    <div class="invoice-footer">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <p class="">**Pembayaran dapat ditransfer ke rekening Bank BCA <strong>4681993988</strong> a/n  <strong>Satria Wibawa</strong></p>
                                            </div>
                                        </div>
