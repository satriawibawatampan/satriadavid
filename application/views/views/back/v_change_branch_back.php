    ...
    <div class="jarviswidget jarviswidget-sortable" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
        ...
        <div role="content">
            ...
            <div class="widget-body no-padding">
                ...
                <form id="smart-form-register" action="<?php echo base_url(); ?>Back/Branch/Change_branch/<?php echo $_SESSION['xcellent_id']; ?>" class="smart-form" novalidate="novalidate" method="post">
                    <header>
                        Change Branch form
                    </header>
                    ...
                    <footer>
                        <input type="submit" name="button_changebranch" class="btn btn-primary" value="Submit">
